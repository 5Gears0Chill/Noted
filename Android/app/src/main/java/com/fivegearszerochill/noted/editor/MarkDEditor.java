package com.fivegearszerochill.noted.editor;
...
import com.fivegearszerochill.noted.editor.components.HorizontalDividerComponent;
import com.fivegearszerochill.noted.editor.components.HorizontalDividerComponentItem;
import com.fivegearszerochill.noted.editor.components.ImageComponent;
import com.fivegearszerochill.noted.editor.components.ImageComponentItem;
import com.fivegearszerochill.noted.editor.components.TextComponent;
...
import com.fivegearszerochill.noted.editor.models.ImageComponentModel;
import com.fivegearszerochill.noted.editor.models.TextComponentModel;
import com.fivegearszerochill.noted.editor.utils.ComponentMetadataHelper;
import com.fivegearszerochill.noted.editor.utils.DraftManager;
import com.fivegearszerochill.noted.editor.utils.MarkDownConverter;
import com.fivegearszerochill.noted.editor.utils.RenderingUtils;
...
public class MarkDEditor extends MarkDCore implements
     ...
     *
     * @param serverUrl          server url for image upload
     * @param serverToken        serverToken
     * @param isDraft            set true when you are loading draft
     * @param startHint          default hint of input box
     * @param defaultHeadingType styling type for the default heading
     */
    ...
    public void addLink(String text, String url) {
        if (_activeView instanceof TextComponentItem) {
            String stringBuilder = " <a href=\"" +
                    url +
                    "\">" +
                    text +
                    "</a> ";
            ((TextComponentItem) _activeView).getInputBox().append(stringBuilder);
        }
    }
